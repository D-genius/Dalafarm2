...
$result = mysqli_query($db, "SELECT * FROM insertproducts WHERE id  = '$insertproducts_id'");
...
$descriptions=$_POST['descriptions'] ;
	...
	mysqli_query($db,"UPDATE insertproducts SET id='$id', fname ='$fname',
		 phonenumber ='$phonenumber', Email='$Email', productname ='$productname',price='$price', descriptions='$descriptions'  WHERE id = '$insertproducts_id'");
